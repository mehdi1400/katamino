...
# In version 2.0 Graphical result show is added.
...
#list of your elements that you want to play with them.
elements=[3,9,2,4,8,6,7]
...
def resultShow():
    ...
    for i in range (0,5):
        for j in range(0,basex):
            ...
            pygame.draw.rect(screen,cl,[left,top,width,height],0)
    pygame.display.flip()
